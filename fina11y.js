...
$(document).on('click','pre[id^="fina11y-manual-error-remarks"]',function(evt){
   
    if($(evt.target).text() === "Enter category"){
        $(evt.target).text() = "";
    }else if($(evt.target).text() === "Enter subCategory"){
        $(evt.target).text() = "";
    }else if($(evt.target).text() === "Enter error code here"){
        $(evt.target).text() = "";
    }else if($(evt.target).text() === "Enter remedy Here"){
        $(evt.target).text() = "";
    }else if($(evt.target).text() === "Add remarks"){
        $(evt.target).text() = "";
    }
});