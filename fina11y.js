...
$(document).on('click','#fina11y-manual-error-replace-btn',(evt)=>{
    ...
    if(emptyTextBox){
        let errorCode = $('#fina11y-manual-error-code').text();
        let errorRemedy = $.parseHTML($('#fina11y-manual-error-remedy')[0].text());
        let manualElement =  findElementByCode(errorCode, 'tota11y-manual-error');
        $(manualElement).replaceWith(errorRemedy);
