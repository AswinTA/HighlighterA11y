...
$(document).on('click', '[id^=fina11y-error-submit-btn]', function (event) {
    ...
    if (confirm('Do You Want to save the remedy ?')) {
        ...
        try{
            ...
            $(this).parent().find(".language-markup.fina11y-error-code-snippet").html(errorSolution);
        }catch(exception){
...
$(document).on('click', '[id^=fina11y-error-re-submit-btn-]', (evt) => {
    ...
    if (confirm('Do You want to re-submit this remedy?')) {
        ...
        try{
            ...
            $(evt.target).parent().find(".language-markup.fina11y-error-code-snippet").html(errorRemedy);
            
        }catch(exception){
            console.log(`${exception} occured during removing the tota11y-add-bg-border classname from remedy`)
        }
